...
export default function VendorWarehouseScreen() {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: theme.background }}>
      <View style={[styles.header, { borderBottomColor: theme.border }]}>
        ...
        <Text style={[styles.headerTitle, { color: theme.text }]}>Warehouse & IoT Dashboard</Text>
      </View>
      <WarehouseDashboard role="vendor" />
    </SafeAreaView>
  );
}
